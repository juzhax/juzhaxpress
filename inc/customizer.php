...
function juzhaxpress_customize_register( $wp_customize ) {
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			...
			'render_callback' => 'juzhaxpress_customize_partial_blogname',
		) );
		$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
			'selector'        => '.site-description',
			'render_callback' => 'juzhaxpress_customize_partial_blogdescription',
		) );
	}
}
add_action( 'customize_register', 'juzhaxpress_customize_register' );
 ...
 * @return void
 */
function juzhaxpress_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function juzhaxpress_customize_partial_blogdescription() {
